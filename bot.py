...
# ==================== CONFIG ====================
BOT_TOKEN = os.getenv("BOT_TOKEN", "8636972939:AAET28CsZ2IZlrllLL6jPvcTWqlTQlPGUsE")
GITHUB_TOKEN = os.getenv("GITHUB_TOKEN", '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')
REPO_OWNER = os.getenv("REPO_OWNER", "wailinkyaw333-debug")
REPO_NAME = os.getenv("REPO_NAME", "FreePK")  # 🔥 ဒီမှာ FreePK လို့ပြင်ထားတယ်
ADMIN_ID = os.getenv("ADMIN_ID", "7853537688")
ADMIN_USERNAME = os.getenv("ADMIN_USERNAME", "@wailinkyaw333")
